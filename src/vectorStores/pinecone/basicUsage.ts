...
async function main() {
    try {
        ...
        results.result.hits.forEach((hit: any) => {
            // Check if hit.score exists before calling toFixed
            const score = hit.score !== undefined ? hit.score.toFixed(2) : "N/A";
            console.log(`id: ${hit.id}, score: ${score}, text: ${hit.fields.chunk_text}, category: ${hit.fields.category}`);
        });
